...
!!! warning "Pflicht ab 2026"
    Die gesetzliche Pflicht zur Führung elektronischer Bußgeldakten greift erst ab dem **1. Januar 2026** (§ 110a Abs. 1 S. 1 OWiG).

**Wesentliche Anforderungen an die Bußgeldbehörden:**

- Erstellung elektronischer Dokumente
- Umgang mit digitalen Beweismitteln
- Umgang mit elektronischen Eingängen Dritter
- Umgang mit Papiereingängen Dritter (Scan-Anforderungen)
- Umgang mit Papierdokumenten der Behörde
- Gewährung von Akteneinsicht
- Übermittlung an die Justiz

### Relevante Rechtsgrundlagen

| Verordnung | Geltungsbereich |
|-----------|----------------|
| BußAktÜbV | Bußgeldaktenübermittlung |
| DokErstÜbV | Dokumentenerstellung und -übermittlung |
| StrafAktEinV | Strafakteneinsicht |
...
- Können **ohne qualifizierte elektronische Signatur** zur Akte genommen werden
- Es genügt, wenn der Name des Sachbearbeitenden als einfacher Schriftzug erkennbar ist
- Alternativ: Feststellbarkeit anhand der Protokolldateien des Computersystems

!!! info "Keine qeS erforderlich"
    § 32b Abs. 1 S. 2 StPO sieht eine qualifiziert elektronische Signatur nur für Dokumente vor, die nach StPO oder OWiG zu unterschreiben sind. Entsprechende Verpflichtungen treffen Bußgeldbehörden in der Praxis **nicht**.

**Aktenbestandteil:** Eine Datei wird Bestandteil der Akte durch bewussten Akt der dauerhaften Aktenaufnahme (§ 3 Abs. 1 BBußAktFV). Entwürfe, Notizen oder Terminerinnerungen werden nicht automatisch Teil der Akte.

**Repräsentat:** Die Sammlung der PDF-Dokumente, welche die Akte im Rechtsverkehr repräsentieren (§ 2 Abs. 2 BBußAktFV). Muss jederzeit erstellbar sein, aber nicht zusätzlich gespeichert werden.
...
- **Prozesserklärungen:** Nur PDF und TIFF (§ 2 Abs. 1 ERVV)
- **Sonstige Dateien:** Nach § 15 ERVV, soweit Sicherheitsbedenken nicht entgegenstehen

**In die Akte zu übernehmen:**
...
1. **EGVP** (§ 110c OWiG i.V.m. § 32a Abs. 3 Alt. 2 StPO)
2. **Sichere Übermittlungswege** (§ 110c OWiG i.V.m. § 32a Abs. 3 Alt. 1 StPO)
...
- **Inline-Signatur** (in die Datei eingebettet)
- **Detached-Signatur** (der Datei beigefügt)

!!! danger "Nicht zulässig"
    **Containersignaturen** sind nicht zulässig (§ 4 Abs. 2 ERVV).
...
1. PDF-Dokument einfach elektronisch signieren (getippter Name reicht)
2. Über sicheren Übermittlungsweg versenden
...
Für bestimmte Erklärungen (§ 32d S. 2 StPO) besteht eine **Nutzungspflicht** – bei Nichteinhaltung droht Unwirksamkeit der Prozesshandlung.
...
|-----------|-------------------|
| Laufendes Verfahren | Mindestens **6 Monate** nach Übertragung |
...
1. **Bereitstellen zum Abruf** (über Akteneinsichtsportal)
2. **Übermittlung** über sicheren Übermittlungsweg (derzeit die Regel)
...
1. Inhalte nicht öffentlich verbreitet oder Dritten zu verfahrensfremden Zwecken übermittelt werden dürfen
2. Personenbezogene Daten nur zweckgebunden verwendet werden dürfen
...
- Übermittlung der **ganzen Akte**
- Übermittlung **einzelner Dokumente**

Übermittlungsweg: Im Regelfall über die **EGVP-Infrastruktur** (beBPo an Justiz).
...
- Elektronische Akte mit **Übernahmeersuchen** übermitteln
...
- Verarbeitung personenbezogener Daten nur soweit **verfahrenserforderlich**
- **Löschung** nach Ablauf der einschlägigen Aufbewahrungsfristen
- Aufbewahrungsfristen sind in den Aufbewahrungsbestimmungen der jeweiligen Landesverwaltungen geregelt
